...
The equivalence can be proven using the **law of cosines**. Place $\vec{a}$ and $\vec{b}$ tail-to-tail; the third side of the triangle is $\vec{a} - \vec{b}$. Expanding $|\vec{a} - \vec{b}|^2$ both algebraically (component-wise) and geometrically (law of cosines) yields the result.
...
- Link 2 pointing at $\vec{L}_2 = (\frac{\sqrt{2}}{2}, \frac{\sqrt{2}}{2}) \approx (0.707, 0.707)$ (at 45° from link 1)

To find the angle between them:

$$\cos(\theta) = \frac{\vec{L}_1 \cdot \vec{L}_2}{|\vec{L}_1||\vec{L}_2|} = \frac{0.707}{1 \times 1} \approx 0.707$$

$$\theta = \arccos(0.707) \approx 45°$$
</Example>
...
1. $\vec{a} \cdot \vec{b} = (3)(2) + (4)(1) = 6 + 4 = **10**$

2. $\cos\theta = \frac{(1)(1) + (0)(1)}{1 \cdot \sqrt{2}} = \frac{1}{\sqrt{2}} \approx 0.707$. So $\theta = \arccos(0.707) = **45°**$

3. $\vec{a} \cdot \vec{b} = (2)(-1) + (1)(3) = -2 + 3 = 1$. $|\vec{a}| = \sqrt{5}$, $|\vec{b}| = \sqrt{10}$. $\cos\theta = \frac{1}{\sqrt{50}} \approx 0.1414$. $\theta = \arccos(0.1414) \approx **81.9°**$

4. $\text{proj}_{\vec{b}}\vec{a} = \frac{(4)(1) + (3)(0)}{1^2}(1, 0) = (4, 0)$. Magnitude = **4**.

5. $\text{proj}_{\vec{n}}\vec{F} = \frac{(10)(0) + (5)(1)}{1^2}(0, 1) = (0, 5)$ N. The perpendicular component is **5 N**.
