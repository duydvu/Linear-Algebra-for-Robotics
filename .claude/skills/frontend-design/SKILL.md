...
## 0. Discover Existing Design System (use memory skill)

**Before designing**: Use the **memory skill** to find existing components and design patterns:

- Retrieve existing UI components, design tokens, and patterns
- Find established color schemes, typography, and spacing conventions
- Discover reusable components to maintain consistency

**After implementing**: Use memory skill to document new patterns for future reuse.
